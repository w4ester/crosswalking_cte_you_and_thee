    ...
    <div class="modal" id="modal-feedback" aria-hidden="true" role="dialog" aria-labelledby="feedbackTitle">
        <div class="modal-content">
            ...
            <div style="display:flex;gap:10px;justify-content:flex-end;margin-top:10px;">
                <button id="copyFeedback" style="background:#0ea5e9;" class="btn-success">Copy</button>
                <button id="emailFeedback" class="btn-success">Email</button>
            </div>
        </div>
    </div>
    <script>
        (function(){
            ...
            const chat = document.getElementById('chatLauncher');
            if (chat) { fab.style.bottom = 'calc(90px + env(safe-area-inset-bottom))'; }
            ...
            document.getElementById('emailFeedback').addEventListener('click', ()=>{ const txt=encodeURIComponent(document.getElementById('feedbackText').value.trim()); const subj=encodeURIComponent('CTE Crosswalks Feedback'); window.location.href=`mailto:occpcteprograms.msde@maryland.gov?subject=${subj}&body=${txt}`; });
        })();
    </script>
</body>
</html>
